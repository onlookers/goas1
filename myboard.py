...
class SimpleGoBoard(object):
    ...
    def Scoring(self,komi):
        ...
        if blackScore > whiteScore:
            finalScore="B\+" + str(blackScore - whiteScore)
        else:
            finalScore="W\+" + str(whiteScore - blackScore)
